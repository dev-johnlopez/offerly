    ...
    initStepForm: function () {
      ...
      this.collection.each(function (i, el) {
        ...
        $('[data-next-step]').on('click', function (e) {
          ...
          currentStepNumber += 1;
          var progress = Math.round((currentStepNumber + 1 ) / totalStepsCount * 100);
